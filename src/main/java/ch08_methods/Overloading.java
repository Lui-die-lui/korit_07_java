...
/*
    method overloading
        [매개변수]의 유무 및 자료형의 차이, 개수의 차이를 나눠서
        ...
        overloading의 장점 :
            ...
            int 끼리의 합 연산을 하는 메서들르 나눈다고 가정했을 때,
            add,
            plus,
...
public class Overloading {
    ...
    public static void add(String s) {
        ...
        System.out.println(s + "!"); // s 값(호출해서 넣은 값) 들어감
    }

    // call2() 유형으로 정의 #2
    public static void add(int a, int b) {
        System.out.println("add(int a, int b)"); // 이 부분과
        System.out.println(a + b);               // 이 부분은 overloading의 결과물
    }
