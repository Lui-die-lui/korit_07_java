...
public class StrList {
    public static void main(String[] args) {
        ...
        // List의 경우 인덱스 넘버 고정이 없지만, 배열의 경우 인덱스 넘버를 고정해줘야함
...
//        List<Person> 혹은 userList
        System.out.println(strArray);
        System.out.println(Arrays.toString(strArray)); // 정적 메서드 사용해야 나옴

        // List     - toString() 오버라이딩
        System.out.println(strList); // 알아서 잘 나옴
        ...
        /*
            이상의 이유는 List element가 명확하게 일치하는지를 확인
            그래서 py가 python 이라는 String 데이터의 일부이기는 하지만
            element 전체를 의미하지는 않기 때문에 false라는 결과값이 도출됨
        */
        ...
        // FIFO / .pop() -> 삭제 여부가 아니라 collection에서 삭제하고 삭제된 element를 return
        System.out.println(strList);
        // List의 정렬
        Collections.sort(strList); // 배열 정렬할 때랑 동일. 원본 List의 결과값을 바꿈
        System.out.println(strList);
