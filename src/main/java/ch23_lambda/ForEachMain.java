...
public class ForEachMain {
    public static void main(String[] args) {
        ...
        // 여기서 저희는 각 element를 추출하기 위해서 for문 / 향상된 for문을 사용해왔음
        // 과일명 :사과
        // 과일명 :딸기
        // 과일명 :블루베리
        ...
        List<Integer> numbeers = Arrays.asList(1,2,3,4,5);
        numbeers.forEach(number -> System.out.print((number*2) + " "));

        // 이상의 forEach문에서 알 수 있는 점은
        // 여태까지 저희가 List 등의 Collection에서 각 element들을 추출하여 데이터를 가공한다고
        // 가정했을 대 필수적으로 List 내부를 돌아다니는 반복문을 작성해야만 했습니다.
