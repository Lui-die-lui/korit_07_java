...
public class LambdaExample {
    public static void main(String[] args) {
        ...
        // calculate를 추론할 수 업섰던 이유 중 하나임

        // 다른 유형의 함수형 인터페이스 실행 예제
        // 2. Supplier -> call3();
        Supplier<String> stringSupplier = () -> "Hello, Supplier1";
        System.out.println(stringSupplier.get());  // 기준 method 관련 + 람다식 지식 필요
        String message = stringSupplier.get();
        System.out.println(message);

        // 3. Consumer -> call2();
        Consumer<String> stringConsumer = (memo) -> System.out.println("메세지 : " + memo);
        stringConsumer.accept("오늘 전반적인 수업 내용은 여기서 끝입니다.");
