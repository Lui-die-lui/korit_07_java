...
//        System.out.println(person1.name);
        // Setter / Getter를 통해서만 데이터를 입력 / 수정 / 조회를 가능하게 하고
        // 필드에 직접 값 대입하는 방식을 막도록 할 예정


        person4.setAge(789);                // 결과 값 : 불가능한 나이 입력입니다.
        System.out.println(person4.age);    // 결과값 : 54 -> 기존나이
        person4.age = 789;                  // 필드에 값을 직접 대입
        System.out.println(person4.age);    // 결과값 : 789

        // 이상과 같은 코드 라인은 특정 방법을 사용하면 부정확한 데이터의 입력이 가능하기때문에
        // 장기적으로는 method를 통한 데이터의 입력 / 수정 / 조회가 필요
        ...
        // 근데 이상과 같이 작성하기 싫어하는 사람은 중간 과정에 변수를 선언하기도 함
